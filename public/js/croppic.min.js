...
(function (window, document) {
	...
	Croppic = function (id, options) {
		...
		that.options = {
			...
			onAfterImgCrop: null,
			afterCropControlRemoveCroppedImage: null
		};
	...
	Croppic.prototype = {
		...
		init: function () {
			...
			that.objW = (that.options.width != 0)? that.options.width : that.obj.width();
			that.objH = (that.options.height != 0)? that.options.height :that.obj.height();
		...
		bindImgUploadControl: function(){
			...
			if( !$.isEmptyObject(that.croppedImg)){
				...
				that.cropControlRemoveCroppedImage.on('click',function(){ 
					...
					if (that.options.afterCropControlRemoveCroppedImage) that.options.afterCropControlRemoveCroppedImage.call(that);
			...
			$.ajax({
		      ...
		      statusCode: {
			      500: function() {
			      	...
			      	that.hideLoader();
			      	if (that.options.afterCropControlRemoveCroppedImage) that.options.afterCropControlRemoveCroppedImage.call(that);
			      	alert("500 Internal Server Error. File too large for processing.");
			      }
			    }
				}).always(function(data){ 
